  ...
  return (
    <div className="premium-bg selection:bg-orange-500/30 selection:text-white flex flex-col min-h-screen">
      ...
      <div className="relative z-10 flex flex-col flex-grow">
        ...
        <nav className="flex items-center justify-center px-6 py-12 md:py-16 max-w-7xl mx-auto w-full">
          <div 
            className="text-6xl md:text-7xl font-black tracking-tighter text-white cursor-pointer select-none transition-transform hover:scale-105" 
        ...
        {/* Header Section */}
        <header className="pt-8 pb-16 px-6 text-center shrink-0">
